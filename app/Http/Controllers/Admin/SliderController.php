...
class SliderController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $slider->btn1_text_ar = $request->btn1_text_ar;
        $slider->btn1_text_en = $request->btn1_text_en;
        $slider->btn2_text_ar = $request->btn2_text_ar;
        $slider->btn2_text_en = $request->btn2_text_en;
