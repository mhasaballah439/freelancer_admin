            ...
            <div class="content-body">
                <section id="file-export">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                @if(admin()->check_route_permission('admin.skills.index') == 1)
                                <div class="card-header" style="padding-bottom: 0px">
                                    <h4 class="card-title">{{__('msg.skills')}}</h4>
                                    <a class="heading-elements-toggle"><i
                                            class="la la-ellipsis-v font-medium-3"></i></a>
                                    <div class="heading-elements">
                                        <ul class="list-inline mb-0">
                                            @if(admin()->check_route_permission('admin.skills.create') == 1)
                                            <li>
                                                <a href="{{route('admin.skills.create')}}" style="border-radius: 10px;padding: 10px"
                                                ...
                                                @foreach($skills as $user)
                                                    <tr class="row_{{$user->id}}">
                                                        ...
                                                        <td class="d-flex align-items-center justify-content-sm-center">
                                                            @if(admin()->check_route_permission('admin.skills.delete') == 1)
                                                            <a href="#" item_id="{{$user->id}}" class="item_delete btn btn-sm btn-danger">
                                                                <i class="la la-trash"></i></a>
                                                            @endif
                                                            @if(admin()->check_route_permission('admin.skills.edit') == 1)
                                                            <a href="{{route('admin.skills.edit',$user-> id)}}"
