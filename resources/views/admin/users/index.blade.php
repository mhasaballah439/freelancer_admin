                                    ...
                                    <div class="card-body card-dashboard">
                                            <table class="table table-striped table-bordered table-responsive file-export">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center">{{__('msg.user_type')}}</th>
                                                ...
                                                @foreach($users as $user)
                                                    <tr class="row_{{$user->id}}">
                                                        ...
                                                        <td class="text-center">
                                                            <img src="{{isset($user->image) && $user->image->file_path ? asset('public'.$user->image->file_path) : ''}}" width="50px">
                                                        </td>
                                                        ...
                                                        <td class="d-flex align-items-center justify-content-sm-center">
                                                            ...
                                                            <a href="#" user_id="{{$user->id}}" class="user_delete btn btn-danger btn-sm">
                                                                <i class="la la-trash"></i></a>
                                                            @endif

                                                            <a href="{{route('admin.users.show',$user->id)}}" target="_blank" class="btn ml-1 btn-warning btn-sm">
