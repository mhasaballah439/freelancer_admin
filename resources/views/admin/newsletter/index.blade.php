            ...
            <div class="content-body">
                <section id="file-export">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                @if(admin()->check_route_permission('admin.newsletter.index') == 1)
                                    ...
                                    <div class="heading-elements">
                                        <ul class="list-inline mb-0">
                                            @if(admin()->check_route_permission('admin.newsletter.create') == 1)
                                                <li>
                                                    <a href="{{route('admin.newsletter.create')}}" style="border-radius: 10px;padding: 10px"
                                    ...
                                    <div class="card-body card-dashboard">
                                            <table class="table table-striped table-bordered file-export">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center">{{__('msg.is_send')}}</th>
                                                    <th class="text-center">{{__('msg.action')}}</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                @foreach($newsletter as $news)
                                                    <tr class="row_{{$news->id}}">
                                                        <td class="text-center">{{$news->id}}</td>
                                                        <td class="text-center">{{$news->title}}</td>
                                                        <td class="text-center">{{$news->is_send == 1 ? 'YES' : 'No'}}</td>

                                                        <td class="d-flex align-items-center justify-content-sm-center">
                                                            @if(admin()->check_route_permission('admin.newsletter.delete') == 1)
                                                            <a href="#" item_id="{{$news->id}}" class="delete_item btn-sm btn btn-danger">
