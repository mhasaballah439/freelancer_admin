                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{route('admin.services.index')}}">{{__('msg.services')}}</a>
                                </li>
                                        ...
                                        @if($service)
                                            ...
                                            <div class="form-body">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="avatar-upload">
                                                                ...
                                                                <div class="avatar-preview">
                                                                    <div id="imagePreview"
                                                                         style="background-image: url({{asset('public/'.$service->image)}});">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="tab-content px-1 pt-1">
                                                        <div role="tabpanel" class="tab-pane active" id="activeAr"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <textarea rows="3" class="form-control border-primary"
                                                                          ...
                                                                          name="desc_ar">{{ $service->desc_ar }}</textarea>
                                                                @error('desc_ar')
                                                                <span class="text-danger">{{$message}}</span>
                                                                @enderror
                                                        ...
                                                        <div class="tab-pane" id="activeEn" role="tabpanel"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <textarea rows="3" class="form-control border-primary"
                                                                          placeholder="{{__('msg.desc')}}"
                                                                          name="desc_en">{{ $service->desc_en }}</textarea>
                                                                @error('desc_en')
                                                                <span class="text-danger">{{$message}}</span>
                                                                @enderror
                                                ...
                                                <div class="form-actions">
                                                    <a href="{{route('admin.services.index')}}" type="button" class="btn btn-warning mr-1 block-page"
