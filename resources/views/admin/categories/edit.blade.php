                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{route('admin.categories.index')}}">{{__('msg.categories')}}</a>
                                </li>
                                <li class="breadcrumb-item active">{{__('msg.edit_category')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                @if(admin()->check_route_permission('admin.categories.edit') == 1)
                                    <div class="card-header">
                                        <h4 class="card-title" id="basic-layout-form">{{__('msg.categories')}} {{$category ? $category->id : '-'}}</h4>
