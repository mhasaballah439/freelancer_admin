                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{route('admin.sliders.index')}}">{{__('msg.sliders')}}</a>
                                </li>
                                <li class="breadcrumb-item active">{{__('msg.edit_slider')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{__('msg.slider')}}</h4>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class=" label-control"
                                                                   for="url">{{__('msg.btn1_url')}}</label>

                                                            <input type="text" id="url"
                                                                   class="form-control border-primary"
                                                                   placeholder="{{__('msg.btn1_url')}}"
                                                                   value="{{ $slider->btn1_url }}"
                                                                   name="btn1_url">
                                                            @error('btn1_url')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class=" label-control"
                                                                   for="url">{{__('msg.btn2_url')}}</label>

                                                            <input type="text" id="url"
                                                                   class="form-control border-primary"
                                                                   placeholder="{{__('msg.btn2_url')}}"
                                                                   value="{{ $slider->btn2_url }}"
                                                                   name="btn2_url">
                                                            @error('btn2_url')
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                ...
                                                <div class="row">
                                                    <ul class="nav nav-tabs nav-top-border no-hover-bg nav-justified">
                                                        <li class="nav-item">
                                                            <a class="nav-link active" id="activeAr-tab1"
                                                               ...
                                                               aria-controls="activeAr" aria-expanded="true"><i class="flag-icon flag-icon-sa"></i>العربية</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="activeEn-tab1" data-toggle="tab"
                                                               href="#activeEn" aria-controls="activeEn"
                                                               aria-expanded="false"><i class="flag-icon flag-icon-us"></i>EN </a>
                                                        </li>
                                                    </ul>
                                                    <div class="tab-content px-1 pt-1">
                                                        <div role="tabpanel" class="tab-pane active" id="activeAr"
                                                            ...
                                                            <div class="form-group row">
                                                                <label class=" label-control"
                                                                       for="url">{{__('msg.btn1_text_ar')}}</label>

                                                                <input type="text" id="url"
                                                                       class="form-control border-primary"
                                                                       placeholder="{{__('msg.btn1_text_ar')}}"
                                                                       value="{{ $slider->btn1_text_ar }}"
                                                                       name="btn1_text_ar">
                                                                @error('btn1_text_ar')
                                                                <span class="text-danger">{{$message}}</span>
                                                                @enderror
                                                            ...
                                                            <div class="form-group row">
                                                                <label class=" label-control"
                                                                       for="url">{{__('msg.btn2_text_ar')}}</label>

                                                                <input type="text" id="url"
                                                                       class="form-control border-primary"
                                                                       placeholder="{{__('msg.btn2_text_ar')}}"
                                                                       value="{{ $slider->btn2_text_ar }}"
                                                                       name="btn2_text_ar">
                                                                @error('btn2_text_ar')
                                                                <span class="text-danger">{{$message}}</span>
                                                                @enderror
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <textarea rows="3" class="form-control border-primary"
                                                                          ...
                                                                          name="desc_ar">{{ $slider->desc_ar }}</textarea>
                                                                @error('desc_ar')
                                                                <span class="text-danger">{{$message}}</span>
                                                                @enderror
                                                        ...
                                                        <div class="tab-pane" id="activeEn" role="tabpanel"
                                                            ...
                                                            <div class="form-group row">
                                                                <label class=" label-control"
                                                                       for="url">{{__('msg.btn1_text_en')}}</label>

                                                                <input type="text" id="url"
                                                                       class="form-control border-primary"
                                                                       placeholder="{{__('msg.btn1_text_en')}}"
                                                                       value="{{ $slider->btn1_text_en }}"
                                                                       name="btn1_text_en">
                                                                @error('btn1_text_en')
                                                                <span class="text-danger">{{$message}}</span>
                                                                @enderror
                                                            ...
                                                            <div class="form-group row">
                                                                <label class=" label-control"
                                                                       for="url">{{__('msg.btn2_text_en')}}</label>

                                                                <input type="text" id="url"
                                                                       class="form-control border-primary"
                                                                       placeholder="{{__('msg.btn2_text_en')}}"
                                                                       value="{{ $slider->btn2_text_en }}"
                                                                       name="btn2_text_en">
                                                                @error('btn2_text_en')
                                                                <span class="text-danger">{{$message}}</span>
                                                                @enderror
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <textarea rows="3" class="form-control border-primary"
                                                                          placeholder="{{__('msg.desc')}}"
                                                                          name="desc_en">{{ $slider->desc_en }}</textarea>
                                                                @error('desc_en')
                                                                <span class="text-danger">{{$message}}</span>
                                                                @enderror
                                                ...
                                                <div class="form-actions">
                                                    <a href="{{route('admin.sliders.index')}}" type="button" class="btn btn-warning mr-1 block-page"
