                                                        ...
                                                        @if(isset($admin->employees) && count($admin->employees) > 0)
                                                                @foreach($admin->employees as $employee)
                                                                    <tr class="row_{{$employee->id}}">
                                                                        ...
                                                                        <td class="text-center">
                                                                            <button type="button" item_id="{{$employee->id}}" class="item_delete btn-sm btn btn-danger">
                                                                                <i class="la la-trash"></i></button>

                                                                            <a href="{{route('admin.permissions.index',$employee->id)}}"
                                                                               target="_blank"
                                                                               class="block-page ml-2 btn btn-warning btn-sm"><i
                                                                                    class="la la-lock text-white"></i></a>
                                                                            <button type="button"
                                                                               class="block-page ml-2 btn btn-primary btn-sm item_edit" item_id="{{$employee->id}}"><i
