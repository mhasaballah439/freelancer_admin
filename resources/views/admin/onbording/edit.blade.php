                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{route('admin.onbording.index')}}">{{__('msg.onbording')}}</a>
                                </li>
                                <li class="breadcrumb-item active">{{__('msg.edit_onbording')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                @if(admin()->check_route_permission('admin.onbording.edit') == 1)
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            @if($onbording)
                                                <form class="form"
                                                      action="{{route('admin.onbording.update',$onbording->id)}}"
                                                      method="post"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="avatar-upload">
                                                                        ...
                                                                        <div class="avatar-preview">
                                                                            <div id="imagePreview"
                                                                                 style="background-image: url({{asset('public/'.$onbording->image)}});">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div role="tabpanel" class="tab-pane active"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <textarea rows="3"
                                                                                  ...
                                                                                  name="desc_ar">{{ $onbording->desc_ar }}</textarea>
                                                                        @error('desc_ar')
                                                                        <span class="text-danger">{{$message}}</span>
                                                                        @enderror
                                                                ...
                                                                <div class="tab-pane" id="activeEn" role="tabpanel"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <textarea rows="3"
                                                                                  class="form-control border-primary"
                                                                                  placeholder="{{__('msg.desc')}}"
                                                                                  name="desc_en">{{ $onbording->desc_en }}</textarea>
                                                                        @error('desc_en')
                                                                        <span class="text-danger">{{$message}}</span>
                                                                        @enderror
